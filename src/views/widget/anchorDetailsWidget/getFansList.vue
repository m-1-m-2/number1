<template>
  <div class='getFansList absolute top bottom left right cl-black fz-12'>
...
export default {
  ...
  created () {
    ...
    this.actions_getFansList({ touid }).then(res => {
  ...
  mounted () { },
  methods: {
    ...mapActions(['actions_getFansList', 'actions_getUserHome', 'actions_rootStore', 'actions_getSetAttent']),
    goToAnchorDetails (v) {
