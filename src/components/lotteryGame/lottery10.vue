<template>
  <div class='lottery10 absolute top bottom left right flex flex-col'>
    <!-- 百人牛牛 -->
    <!-- 历史开奖 -->
            ...
            <van-list v-model="loading"
              ...
              <div class="px-10 box-border mb-4"
                ...
                <div class="h-60 flex items-center">
                  <div class="w-2 fz-12 h-60 relative cl-white">
                    <!-- {{v.open_result}} -->
                    <result10 :result="v.open_result"
                              :val="v"
                              :show="false"></result10>
                  </div>
                </div>
...
import { result10 } from "./exhibitResult/index.js";

export default {
  name: 'lottery10',
  components: { lotteryBetHistory, oldVersionBet, result10 },
