<template>
  <div class='lottery11 absolute top bottom left right flex flex-col'>
    <!-- 百人牛牛 -->
    <!-- 历史开奖 -->
            ...
            <van-list v-model="loading"
              ...
              <div class="px-10 box-border mb-4"
                ...
                <div class="h-48 flex items-center">
                  <div class="h-48 relative cl-white w-full">
                    <result11 :result="v.open_result"
                              :order="true"></result11>
                  </div>
                </div>
              </div>
...
import { result11 } from "./exhibitResult/index.js";

export default {
  name: 'lottery11',
  components: { lotteryBetHistory, oldVersionBet, result11 },
