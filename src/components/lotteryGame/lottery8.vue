<template>
  <div class='lottery8 absolute top bottom left right flex flex-col'>
    <!-- 一分六合彩 -->
    <!-- 历史开奖 -->
            ...
            <van-list v-model="loading"
              ...
              <div class="px-10 box-border mb-4"
                ...
                <div class="h-30 flex items-center">
                  <div class="w-164 h-24 relative cl-white">
                    <result8 :result="v.open_result"></result8>
                  </div>
                </div>
              </div>
            </van-list>
...
import { result8 } from "./exhibitResult/index.js";

export default {
  name: 'lottery8',
  components: { lotteryBetHistory, oldVersionBet, result8 },
