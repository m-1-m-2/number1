<template>
  <div class='lottery26 absolute top bottom left right flex flex-col'>
    <!-- 一分快三 -->
    <!-- 280 -->
      ...
      <div class="absolute right-4 top-4 h-36 w-64 box-border rounded-4"
        ...
        <div class="w-full h-full relative">
          ...
          <div class="h-20 w-full absolute bottom left relative cl-white rounded-4">
            <result26 :result="getters_getBetViewInfo.lastResult.open_result"></result26>
          </div>
        </div>
      </div>
    </div>
...
import result26 from "./exhibitResult/result26";
...
export default {
  name: 'lottery26',
  components: { lotteryBetHistory, result26, chips, oldVersionBet },
