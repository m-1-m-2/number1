<template>
  <div class='ways28 fz-12 cl-white absolute top bottom left right'>
    <div class="flex flex-wrap px-2 box-border">
      <div v-for="(v, k) in list"
           class="w-Equally-3 h-120 p-all-2 box-border relative"
           :class="[`order-${k}`]"
           :key="k + 'ways28'">
        <div class="bg-mask-white w-full h-full flex flex-col items-center justify-center rounded-8 relative"
          ...
          <div class="absolute bottom-16">x{{v.value}}</div>
