<template>
  <div class='lobby27 top bottom left right absolute flex flex-col'>
          ...
          <div class="absolute right-4 top-4 h-36 w-64 box-border rounded-4"
            ...
            <div class="w-full h-full relative">
              ...
              <div class="h-20 w-full absolute bottom left relative cl-white rounded-4"
                   v-if="getters_getHomeBetViewInfo.lotteryType == 27">
                <result27 :result="getters_getHomeBetViewInfo.lastResult.open_result"></result27>
              </div>
            </div>
          </div>
        </div>
...
import result27 from "@/components/lotteryGame/exhibitResult/result27";
import { ways27 } from "./ways";
import { graphics27 } from "./graphics";
...
export default {
  name: 'lobby27',
  components: { lotteryBetHistory, chips, ways27, result27, graphics27, scrollDiv },
  ...
  methods: {
    ...
    init_zstList () {
      let params = { page: 0, lottery_type: 27 }
