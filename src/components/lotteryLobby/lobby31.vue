<template>
  <div class='lobby31 top bottom left right absolute flex flex-col'>
    <div class="w-full h-140 flex cl-white">
      ...
      <div class="flex-1 box-border pt-8">
        <div class="h-30 w-full relative flex justify-center items-center z-index-50">
          <div class="flex px-20 rounded-4 relative top"
        ...
        <div class="h-42 w-full flex flex-col">
          ...
          <div class="absolute right-4 top-4 h-36 w-64 box-border rounded-4"
            ...
            <div class="w-full h-full relative">
              <img src="~@/assets/images/game_historys.png"
                   class="w-full h-full"
                   alt="">
              <div class="h-20 w-full text-center line-20 fz-12 absolute bottom left relative cl-white rounded-4">
        ...
        <div class="flex-1 relative">
          <div class="absolute top bottom left right scroll-x bg-white"
            ...
            <div class="h-96 relative w-fit">
              ...
              <!-- 绘制图案 -->
              <graphics31 :list="zstList"
                          v-if="zstList.length !=0"
                          :openAwardData="openAwardData"
                          @changeNumberVar="changeNumberVar"
                          class="h-96 w-fit absolute top left"></graphics31>
            </div>
          </div>
        </div>
      </div>
...
import POKER_lh_trans from "@/components/lotteryGame/exhibitResult/POKER_lh_trans";
import POKER_lh from "@/components/lotteryGame/exhibitResult/POKER_lh";
import scrollDiv from "@/components/lotteryGame/widget/scrollDiv";
import { ways31 } from "./ways";
import { graphics31 } from "./graphics";
...
export default {
  name: 'lobby31',
  components: { lotteryBetHistory, chips, ways31, graphics31, POKER_lh_trans, POKER_lh, scrollDiv },
    ...
    initSocket () {
      ...
      this.mSocket.on(event, (rawResponse) => {
        ...
        if (msgID == 9 && result.msg.lotteryType == currentLotteryType) {
          ...
          this.getters_getHomeBetViewInfo.lastResult.open_result = result_array[result.msg.lh.whoWin];
          this.openAwardData = result;

          this.delayFn(() => { this.changeTimeBoolean = true; }, 4500);
