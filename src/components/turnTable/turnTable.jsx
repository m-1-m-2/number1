            ...
            <div class="turn-table-box">
              ...
              >
                {this.$slots.centerText ? (
                  <div style={{ fontSize: '12px', color: '#F22E00' }}>
                    {this.$slots.centerText}
                  </div>
                ) : this.ifCenterText ? (
                  <span style={{ fontSize: '12px', color: '#F22E00' }}>
                    {this.count_ + '次'}{' '}
                  </span>
                ) : (
                  ''
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <div class="fz-8 line-24">{item.item_name}</div>
                          <div class="prize-pic">
                            {item.item_icon ? <img class="w-24 h-24" src={item.item_icon} /> : ''}
                          </div>
                          <div class="fz-8 line-16">{item.item_num}</div>
                        </div>
                      </div>
                    </div>
                  )
